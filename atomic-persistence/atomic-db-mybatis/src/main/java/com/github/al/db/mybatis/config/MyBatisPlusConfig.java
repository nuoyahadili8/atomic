...
public class MyBatisPlusConfig {
    ...
    static final String MB_MAPPER_PACKAGE = "com.github.al.**.mapper";
    static final String MB_MODEL_PACKAGE = "com.github.al.**.entity";
    static final String MB_ENUMS_PACKAGE = "com.github.al.**.entity.enums";
